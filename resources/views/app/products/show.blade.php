        ...
        <div class="container mx-auto px-4 py-8">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full md:w-1/2 px-4">
                    ...
                    <div class="mb-4">
                        <span class="text-2xl font-bold mr-2">Precio estimado: ${{ $product->price }}</span>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold mb-2">Caracteristicas:</h3>
                        <ul class="list-disc list-inside text-gray-700">
                            @if ($product->is_featured)
                                <li>
                                    <i class="fa-solid fa-star text-yellow-400"></i> Destacado
                                </li>
                            @endif

                            @if ($product->is_best_seller)
                                <li>
                                    <i class="fa-solid fa-medal text-blue-500"></i> Mas vendido
                                </li>
                            @endif
                            @if ($product->is_new_from_stock)
                                <li>
                                    <i class="fa-solid fa-box text-green-500"></i> Nuevo de Stock
                                </li>
                            @endif
                        </ul>
                    </div>
